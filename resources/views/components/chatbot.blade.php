    ...
    document.addEventListener('click', function (e) {
        if (e.target.classList.contains('quick-btn')) {
            ...
            let defaultAnswer = "";
                switch (question) {
                    case "Vận chuyển":
                        defaultAnswer = "🚚 Chúng tôi giao hàng toàn quốc trong 2-5 ngày tùy khu vực. Đơn hàng sẽ được đóng gói an toàn và có mã vận đơn để bạn dễ dàng theo dõi.";
                        break;
                    case "Đổi trả":
                        defaultAnswer = "🔄 Bạn có thể đổi trả sản phẩm trong vòng 7 ngày nếu có lỗi từ nhà sản xuất. Vui lòng giữ nguyên hộp và phụ kiện khi gửi lại để được hỗ trợ nhanh chóng.";
                        break;
                    case "Thanh toán":
                        defaultAnswer = "💳 Chúng tôi hỗ trợ thanh toán khi nhận hàng (COD) và chuyển khoản ngân hàng. Bạn có thể lựa chọn phương thức phù hợp nhất khi đặt hàng.";
                        break;
                    case "Khuyến mãi":
                        defaultAnswer = "🎁 Giảm ngay 10% cho đơn hàng đầu tiên từ 2 triệu đồng. Ngoài ra, chúng tôi thường xuyên có các chương trình ưu đãi vào dịp lễ và cuối tuần.";
                        break;
                    case "Kích thước sản phẩm":
                        defaultAnswer = "📐 Kích thước chi tiết của sản phẩm được ghi rõ trong phần mô tả. Nếu bạn cần tư vấn chọn kích thước phù hợp với không gian, hãy Liên hệ với chúng tôi để hỗ trợ.";
                        break;
                    default:
                        defaultAnswer = "❓ Xin lỗi, hiện tại chúng tôi chưa có sẵn câu trả lời cho vấn đề này. Bạn có thể để lại thông tin để nhân viên hỗ trợ trực tiếp.";
                }
