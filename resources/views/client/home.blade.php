                                    ...
                                    <div class="grouptab">
                                        <div class="product-tab categoriestab-left flex-9">
                                            ...
                                            <div id="armchair" class="tab-pane fade">
                                                ...
                                                <div class="content-showmore text-center has-showmore">
                                                    <button type="button" class="btn btn-default novShowMore"
                                                        data-loading="Loading..." data-loadmore="Load More Products">
                                                        <span>Load More Products</span>
                                                    </button>
                                                    <input type="hidden" value="0" class="count_showmore">
                                                </div>
                                ...
                                <div class="item text-center">
                                    <div class="product-miniature js-product-miniature item-one first-item">
                                        ...
                                        <div class="product-buttons d-flex justify-content-center">
                                            ...
                                            {{-- Wishlist Button --}}
                                            @auth
                                            <form action="{{ route('client.wishlist.toggle', $product->id) }}"
                                                method="POST" class="d-inline">
                                                @csrf
                                                <a class="addToWishlist wishlistProd_{{ $product->id }}" href="#"
                                                    onclick="event.preventDefault(); this.closest('form').submit();"
                            ...
                            <div class="item text-center">
                                <div class="product-miniature js-product-miniature item-one first-item">
                                    <div class="thumbnail-container">
                                        ...
                                        @if ($product->promotion_price && $product->promotion_price < $product->
                                            base_price)
                                            <div class="product-flags discount">
                                                -{{ number_format(100 - ($product->promotion_price /
                                    ...
                                    <div class="product-description">
                                        <div class="product-groups">
                                            ...
                                            <div class="product-group-price">
                                                <div class="product-price-and-shipping">
                                                    <span class="price">{{ number_format($product->promotion_price ??
                                                        $product->base_price, 0, ',', '.') }}₫</span>
                                                    @if ($product->promotion_price && $product->promotion_price <
                                                        $product->base_price)
                                                        <del class="regular-price">{{
                                                            number_format($product->base_price, 0, ',', '.') }}₫</del>
                                                        @endif
                                                </div>
                                            </div>
                                        </div>
