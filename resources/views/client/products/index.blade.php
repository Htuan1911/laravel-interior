                                ...
                                <div class="sidebar-3 sidebar-collection col-lg-3 col-md-4 col-sm-4">
                                    ...
                                    <div class="sidebar-block">
                                        ...
                                        <div class="block-content">
                                            ...
                                            @php
                                            $translatedName = $category->translations->first()->name ?? 'Danh mục';
                                            $active = request('category_id') == $category->id;
                                            @endphp

                                            <div class="cateTitle hasSubCategory level1 {{ $active ? 'open' : '' }}">
                                    ...
                                    <div class="sidebar-block">
                                                ...
                                                <li>
                                                    <label class="check">
                                                        <input type="checkbox" name="material[]" value="{{ $material }}"
                                                            {{
                                                            collect(request()->input('material'))->contains($material) ?
                                                        'checked' : '' }}
                                                        >
                                                        <span class="checkmark"></span>
                                                    </label>
                                        ...
                                        {{-- PRICE FILTER --}}
                                        <form method="GET" action="{{ route('client.products.index') }}" class="mb-4">
                                                    ...
                                                    <div class="products-sort-order dropdown">
                                                        <form method="GET" id="sortForm">
                                                            <select class="select-title" name="sort"
                                                                ...
                                                                <option value="name_asc" {{ request('sort')=='name_asc'
